...
#ifdef FEATURE_QUALCOMM_BUG_FIX_LCD_MDP4_ABNOMAL_RESET	
       mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);	
#endif
...
#ifndef FEATURE_QUALCOMM_BUG_FIX_LCD_MDP4_ABNOMAL_RESET
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
#endif
...
#ifdef FEATURE_QUALCOMM_BUG_FIX_LCD_OVERLAY_BLINK
